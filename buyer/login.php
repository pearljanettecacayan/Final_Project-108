...
<body>
    <div class="login-form">
        ...
        <h1 class="text-center">Welcome Back to FitFusion</h1>
        <h5>Login to Your Account</h5>
        <form action="../serverdb/loginbuyerdb.php" method="post">
        ...
        <div class="text-center" style="margin-top: 15px;">
            <p>Don't have an account yet? <a href="register.php" style="color: #A87676; text-decoration: none; font-weight: bold;">Sign up here</a></p>
        </div>
    </div>
</body>
</html>
